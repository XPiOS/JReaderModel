//
//  JReaderScrollAnimationViewController.m
//  JReaderDemo
//
...
@interface JReaderScrollAnimationViewController () 


@end

@implementation JReaderScrollAnimationViewController
...
- (void)panGesChanged: (CGFloat)pointX {
    ...
    if (self.isLeftPan) {
        ...
        self.nextViewController.view.frame = CGRectMake(self.currentViewController.view.frame.origin.x + self.currentViewController.view.frame.size.width, 0, JREADER_SCREEN_WIDTH, JREADER_SCREEN_HEIGHT);
    } else {
        self.currentViewController.view.frame = CGRectMake(pointX < 0 ? 0 : pointX, 0, JREADER_SCREEN_WIDTH, JREADER_SCREEN_HEIGHT);
        self.nextViewController.view.frame = CGRectMake(self.currentViewController.view.frame.origin.x - JREADER_SCREEN_WIDTH, 0, JREADER_SCREEN_WIDTH, JREADER_SCREEN_HEIGHT);
    }
}
#pragma mark 拖动结束
